...
class TransparentTileDrawable(context: Context, large: Boolean) : BaseDrawable() {
	private val paint = Paint()

	init {
		val density = ResourceUtils.obtainDensity(context)
		val bitmap = GraphicsUtils.generateNoise(if (large) 80 else 40, density.toInt(),
				COLOR_MIN shl 24 or 0x00ffffff, COLOR_MAX shl 24 or 0x00ffffff)
