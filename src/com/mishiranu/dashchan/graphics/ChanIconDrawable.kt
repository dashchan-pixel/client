...
class ChanIconDrawable(private val drawable: Drawable) : BaseDrawable() {
	...
	override fun draw(canvas: Canvas) {
		...
		if (colorFilter == null && tint != null) {
			colorFilter = PorterDuffColorFilter(tint.getColorForState(state, tint.defaultColor),
		...
		if (colorFilter == null) {
			...
			canvas.saveLayer(bounds.left.toFloat(), bounds.top.toFloat(),
