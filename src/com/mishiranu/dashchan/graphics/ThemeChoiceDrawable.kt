...
class ThemeChoiceDrawable(private val background: Int, private val primary: Int,
		private val accent: Int) : BaseDrawable() {
	...
	override fun draw(canvas: Canvas) {
		...
		if (accent != primary && accent != Color.TRANSPARENT) {
			...
			rectF.set((cx - radius).toFloat(), (cy - radius).toFloat(),
