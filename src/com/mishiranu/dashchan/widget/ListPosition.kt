...
class ListPosition(@JvmField val position: Int, @JvmField val offset: Int) : Parcelable {
	...
	companion object {
		@JvmStatic
		fun obtain(recyclerView: RecyclerView, positionTest: PositionTest?): ListPosition? {
			val rect = Rect()
		...
		@JvmField
		val CREATOR: Parcelable.Creator<ListPosition> = object : Parcelable.Creator<ListPosition> {
