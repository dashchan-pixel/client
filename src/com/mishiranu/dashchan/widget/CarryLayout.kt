...
class CarryLayout : ViewGroup {
	...
	override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
		...
		val childWidthMeasureSpec = if (widthUnspecified) MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED)
		...
		for (i in 0 until count) {
			...
			if (measure) {
				val childHeightMeasureSpec = getChildMeasureSpec(heightMeasureSpec, vertialPaddings,
						layoutParams.height)
