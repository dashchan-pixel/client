...
class RecyclerScrollTracker(private val listener: OnScrollListener) {
	...
	interface OnScrollListener {
		fun onScroll(view: ViewGroup, scrollingDown: Boolean, totalItemCount: Int, first: Boolean, last: Boolean)
	}
}
