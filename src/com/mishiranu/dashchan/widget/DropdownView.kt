...
class DropdownView(context: Context, attrs: AttributeSet?) : FrameLayout(context, attrs) {
	...
	init {
		...
		val bitmap = Bitmap.createBitmap(editText.measuredWidth,
				editText.measuredHeight, Bitmap.Config.ARGB_8888)
