...
class ProgressDialog
    ...
    constructor(
        context: Context,
        private val progressFormat: String?,
    ) : AlertDialog(context) {
        ...
        init {
            ...
            val layout = LinearLayout(dialogContext)
            val density = ResourceUtils.obtainDensity(dialogContext)
            ...
            if (progressFormat == null) {
                ...
                val progressBar = ProgressBar(dialogContext, null, android.R.attr.progressBarStyle)
                ...
                val message = TextView(dialogContext)
                layout.addView(
                    message,
                ...
                val progressBar = ProgressBar(dialogContext, null, android.R.attr.progressBarStyleHorizontal)
                ThemeEngine.applyStyle(progressBar)
                layout.addView(
                    progressBar,
                    LinearLayout.LayoutParams.MATCH_PARENT,
                ...
                this.progressBar = progressBar
                message = null
                val inner = LinearLayout(dialogContext)
                layout.addView(
                    inner,
                    LinearLayout.LayoutParams.MATCH_PARENT,
                    LinearLayout.LayoutParams.WRAP_CONTENT,
                ...
                val percent = TextView(dialogContext)
                inner.addView(
                    percent,
                    LinearLayout.LayoutParams.WRAP_CONTENT,
                    LinearLayout.LayoutParams.WRAP_CONTENT,
                ...
                val progress = TextView(dialogContext)
