...
class CustomSearchView(context: Context) : FrameLayout(context), CollapsibleActionView {
	...
	init {
		...
		val typedArray = context.obtainStyledAttributes(null,
				intArrayOf(android.R.attr.contentInsetEnd), android.R.attr.actionBarStyle, 0)
	...
	override fun dispatchKeyEventPreIme(event: KeyEvent): Boolean {
		return if (searchView.hasFocus() && event.keyCode == KeyEvent.KEYCODE_BACK) {
