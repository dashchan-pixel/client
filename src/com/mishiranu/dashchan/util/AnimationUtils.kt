...
object AnimationUtils {
	...
	@JvmStatic
	fun ofHeight(view: View, from: Int, to: Int, needMeasure: Boolean): Animator {
		var realFrom = from
		var realTo = to
	...
	private class HeightAnimatorListener(private val view: View, private val resultingHeight: Int) :
	...
	class VisibilityListener(private val view: View, private val visibility: Int) :
