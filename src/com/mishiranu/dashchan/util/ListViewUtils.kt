...
object ListViewUtils {
    ...
    private fun <T, VH : RecyclerView.ViewHolder> handleClick(
        holder: VH,
        longClick: Boolean,
        dataCallback: DataCallback<T>?,
        callback: ClickCallback<T, VH>,
    ): Boolean {
    ...
    fun <T, VH : RecyclerView.ViewHolder> bind(
        ...
        longClick: Boolean,
        dataCallback: DataCallback<T>?,
        clickCallback: ClickCallback<T, VH>,
    ): VH {
    ...
    fun <T, VH : RecyclerView.ViewHolder> bind(
        ...
        dataCallback: DataCallback<T>?,
        clickCallback: ClickCallback<T, VH>,
    ): VH = bind(holder, holder.itemView, longClick, dataCallback, clickCallback)
    ...
    private class TopLinearSmoothScroller(
        context: Context,
        targetPosition: Int,
    ...
    @JvmStatic
    fun getScrollJumpThreshold(context: Context): Int = context.resources.configuration.screenHeightDp / 40
    ...
    @JvmStatic
    fun colorizeListThumbDrawable4(
        context: Context,
        drawable: Drawable,
    ): Drawable {
