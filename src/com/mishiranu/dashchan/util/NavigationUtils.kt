...
object NavigationUtils {
    ...
    fun shareText(
        ...
        if (uri != null) {
            val activities =
                context.packageManager.queryIntentActivities(Intent(Intent.ACTION_VIEW).setData(uri), PackageManager.MATCH_DEFAULT_ONLY)
