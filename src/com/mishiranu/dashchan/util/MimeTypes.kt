...
object MimeTypes {
	...
	private val EXTENSION_MAP = HashMap<String, String>().apply {
	...
	@JvmStatic
	@JvmOverloads
	fun forExtension(extension: String?, defaultMimeType: String? = null): String? {
		if (!extension.isNullOrEmpty()) {
			val lower = extension.lowercase(Locale.US)
			val mimeType = MIME_TYPE_MAP[lower]
	...
	@JvmStatic
	@JvmOverloads
	fun toExtension(mimeType: String?, defaultExtension: String? = null): String? {
		if (!mimeType.isNullOrEmpty()) {
			val extension = EXTENSION_MAP[mimeType]
