...
object ViewUtils {
    ...
    @JvmStatic
    fun isGestureNavigationOverlap(
        view: View,
        checkLeft: Boolean,
        checkRight: Boolean,
    ): Boolean {
    ...
    @JvmStatic
    fun setBackgroundPreservePadding(
        view: View,
        drawable: Drawable?,
    ) {
    ...
    private class WindowFocusListenerView(
        context: Context,
    ) : View(context) {
    ...
    fun getOutlineRect(
        outline: Outline,
        outRect: Rect,
    ): Boolean = outline.getRect(outRect)
