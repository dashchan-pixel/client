...
object ResourceUtils {
    ...
    init {
        ...
        TYPEFACE_MEDIUM =
            if (regularPixels.contentEquals(mediumPixels)) {
    ...
    @JvmStatic
    fun isTabletOrLandscape(configuration: Configuration): Boolean = configuration.orientation == Configuration.ORIENTATION_LANDSCAPE || isTablet(configuration)
    ...
    fun getColonString(
        ...
        resId: Int,
        formatArg: Any?,
    ): String = resources.getString(R.string.__colon_format, resources.getString(resId), formatArg)
    ...
    @JvmStatic
    fun getSystemSelectorColor(context: Context): Int = getColor(context, android.R.attr.colorControlHighlight)
    ...
    @JvmStatic
    fun obtainAlertDialogLayoutResId(
        context: Context,
