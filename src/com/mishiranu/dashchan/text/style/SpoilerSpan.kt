...
class SpoilerSpan : CharacterStyle(), UpdateAppearance, CommentTextView.ClickableSpan, ColorScheme.Span {
	...
	override fun updateDrawState(paint: TextPaint) {
		if (!enabled || isVisible) {
			...
			paint.bgColor = if (clicked) GraphicsUtils.mixColors(backgroundColor, clickedColor)
