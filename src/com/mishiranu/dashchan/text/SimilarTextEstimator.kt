...
class SimilarTextEstimator(private val maxLength: Int, private val removePostLinks: Boolean) {
	fun <E> checkSimiliar(wordsData1: WordsData<E>?, wordsData2: WordsData<E>?): Boolean {
	...
	class WordsData<E>(@JvmField val words: Set<String>, @JvmField val count: Int) {
