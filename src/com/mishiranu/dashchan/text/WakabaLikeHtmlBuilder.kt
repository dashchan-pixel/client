...
class WakabaLikeHtmlBuilder(
    ...
    init {
        ...
        for (i in STYLES.indices) {
            ...
            builder
                .append("stylesheet\" type=\"text/css\" href=\"")
                .append(uri)
                .append("\" title=\"")
                .append(title)
                .append("\" />\n")
        ...
        for ((title, _) in STYLES) {
            builder
                .append("[ <a href=\"javascript:switchStyle('")
                .append(title)
                .append("');\">")
                .append(title)
                .append("</a> ]\n")
        ...
        if (number != null) {
            ...
            if (originalPost) {
                ...
                builder
                    ...
                    .append("<td class=\"reply\" id=\"reply")
                    .append(number)
                    .append("\">\n")
                appendHeader(false)
                appendFiles()
    ...
    private fun appendHeader(originalPost: Boolean) {
        ...
        for (iconItem in iconItems) {
            builder
                .append("<img data-icon=\"true\" class=\"postericon\" src=\"")
                .append(iconItem.imageFile)
                .append("\"")
    ...
    private fun appendFile(
        ...
        builder
            .append("<span class=\"filesize\" data-file=\"")
            .append(fileItem.imageFile)
            .append("\" data-thumbnail=\"")
            .append(fileItem.thumbnailFile.orEmpty())
        if (!StringUtils.isEmpty(fileItem.originalName)) {
            builder.append("\" data-original-name=\"").append(escapeHtml(fileItem.originalName))
        }
        builder
            .append("\" data-size=\"")
            .append(fileItem.size)
            .append("\" data-width=\"")
            .append(fileItem.width)
            .append("\" data-height=\"")
            .append(fileItem.height)
            .append("\">\n")
        builder
            .append("File: <a target=\"_blank\" href=\"")
            .append(fileItem.imageFile)
            .append("\">")
            .append(fileItem.displayName)
            .append("</a>\n")
    ...
    companion object {
        ...
        private val DATE_FORMAT =
            SimpleDateFormat("MM/dd/yy(ccc)HH:mm:ss", Locale.US).apply {
