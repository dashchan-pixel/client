...
class ThemeDialog : DialogFragment() {
    ...
    private class Adapter(
        context: Context,
        private val themes: List<ThemeEngine.Theme>,
        private val callback: InnerCallback,
        ...
        private class ItemViewHolder(
            ...
            init {
                ...
                itemView.setPadding(
                    itemView.paddingLeft + (8f * density).toInt(),
                    itemView.paddingTop,
                    itemView.paddingRight + (8f * density).toInt(),
