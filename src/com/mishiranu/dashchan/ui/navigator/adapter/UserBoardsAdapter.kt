...
class UserBoardsAdapter(private val callback: Callback) :
	...
	private fun copyItem(position: Int): ChanDatabase.BoardItem {
		return boardItem.update(moveTo(position)).copy()
	}

	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
		return ListViewUtils.bind(SimpleViewHolder(ViewFactory.makeTwoLinesListItem(parent, 0).view),
