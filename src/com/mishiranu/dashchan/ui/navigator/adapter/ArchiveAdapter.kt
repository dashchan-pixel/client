...
class ArchiveAdapter(
    ...
    override fun getItemCount(): Int = (if (filterText != null) filteredArchiveItems else archiveItems).size

    private fun getItem(position: Int): ThreadSummary = (if (filterText != null) filteredArchiveItems else archiveItems)[position]
