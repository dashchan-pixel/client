...
class HistoryPage : ListPage(), HistoryAdapter.Callback, GetHistoryTask.Callback {
	...
	private fun showItemPopupMenu(fragmentManager: FragmentManager, historyItem: HistoryDatabase.HistoryItem) {
	...
	companion object {
		private fun showClearHistoryDialog(fragmentManager: FragmentManager, chanName: String?) {
			InstanceDialog(fragmentManager, null) { provider ->
