...
interface FragmentHandler {
    ...
    fun getActionBarIcon(attr: Int): Drawable? = ResourceUtils.getActionBarIcon(getToolbarContext(), attr)
    ...
    fun navigateTargetAllowReturn(
        chanName: String?,
        navigationData: ChanLocator.NavigationData,
    )
    ...
    fun setActionBarLocked(
        locker: String,
        locked: Boolean,
    )

    fun setNavigationAreaLocked(
        locker: String,
        locked: Boolean,
    )
}
