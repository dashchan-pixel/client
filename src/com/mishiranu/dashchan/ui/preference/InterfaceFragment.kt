...
class InterfaceFragment : PreferenceFragment() {
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		addCheck(true, Preferences.KEY_SWIPE_TO_HIDE_THREAD, Preferences.DEFAULT_SWIPE_TO_HIDE_THREAD,
				R.string.swipe_to_hide_thread, 0)
		...
		addCheck(true, Preferences.KEY_SHOW_IMPORTANT_POSTS_ON_FASTSCROLL_BAR,
				Preferences.DEFAULT_SHOW_IMPORTANT_POSTS_ON_FASTSCROLL_BAR,
				R.string.show_important_posts_on_fastscroll_bar, 0)
		addDependency(Preferences.KEY_SHOW_IMPORTANT_POSTS_ON_FASTSCROLL_BAR,
				Preferences.KEY_ACTIVE_SCROLLBAR, true)
		addCheck(true, Preferences.KEY_SHOW_POSTS_BORDERS, Preferences.DEFAULT_SHOW_POSTS_BORDERS,
				R.string.show_posts_borders, 0)
