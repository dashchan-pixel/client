...
object PreferenceSearch {
    ...
    private val ENTRIES =
        listOf(
            ...
            Entry(Screen.MEDIA, R.string.player, R.string.action_on_playback_completion, 0),
            Entry(Screen.MEDIA, R.string.player, R.string.play_after_scroll, R.string.play_after_scroll__summary),
            Entry(Screen.MEDIA, R.string.player, R.string.seek_any_frame, R.string.seek_any_frame__summary),
            Entry(Screen.MEDIA, R.string.player, R.string.multi_tap_seek, R.string.multi_tap_seek__summary),
            Entry(Screen.MEDIA, R.string.player, R.string.playback_speed_options, 0),
