...
class AboutFragment : PreferenceFragment(), FragmentHandler.Callback {
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		val versionDate = TextFragment.formatChangelogDate(
	...
	class BackupDialog : DialogFragment(), DialogInterface.OnClickListener {
	...
	class RestoreEntriesDialog : DialogFragment {
		...
		override fun onCreateDialog(savedInstanceState: Bundle?): AlertDialog {
			...
			val checked = if (savedInstanceState != null)
					savedInstanceState.getStringArrayList(EXTRA_CHECKED) else null
