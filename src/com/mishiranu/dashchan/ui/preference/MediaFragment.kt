...
class MediaFragment : PreferenceFragment(), FragmentHandler.Callback {
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		val subdirectoryPreference = addEdit(Preferences.KEY_SUBDIR_PATTERN,
		...
		val useInternalStorageForCachePreference = addCheck(true, Preferences.KEY_USE_INTERNAL_STORAGE_FOR_CACHE,
				Preferences.DEFAULT_USE_INTERNAL_STORAGE_FOR_CACHE, R.string.use_internal_storage_for_cache,
