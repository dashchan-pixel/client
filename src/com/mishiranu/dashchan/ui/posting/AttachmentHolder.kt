...
class AttachmentHolder(@JvmField val view: View, @JvmField val fileName: TextView,
		@JvmField val fileSize: TextView, @JvmField val imageView: ImageView,
		@JvmField val warningButton: View, @JvmField val ratingButton: View) {
