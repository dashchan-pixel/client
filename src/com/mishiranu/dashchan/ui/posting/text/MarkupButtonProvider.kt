...
open class MarkupButtonProvider private constructor(
	...
	fun createButton(context: Context, defStyleAttr: Int): Button {
		return object : Button(context, null, defStyleAttr) {
	...
	open fun getSpan(context: Context): Any? {
		return span
	}
	...
	companion object {
		...
		@JvmStatic
		fun obtainSupportedAndDisplayedTags(markup: ChanMarkup?, boardName: String?,
				density: Float, maxButtonsWidth: Int, buttonMarginLeft: Int): Pair<Int, Int> {
