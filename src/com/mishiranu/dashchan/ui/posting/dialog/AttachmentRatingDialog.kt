...
class AttachmentRatingDialog() : DialogFragment(), DialogInterface.OnClickListener {
	...
	private fun getAttachmentHolder(): AttachmentHolder? {
		return (parentFragment as PostingDialogCallback)
	...
	override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
		...
		return AlertDialog.Builder(activity).setTitle(R.string.rating).setSingleChoiceItems(items,
