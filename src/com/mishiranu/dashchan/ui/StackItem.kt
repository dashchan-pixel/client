...
class StackItem : Parcelable {
	...
	fun interface SaveFragment {
		fun save(fragmentManager: FragmentManager, fragment: Fragment): Fragment.SavedState?
	}
	...
	constructor(fragmentManager: FragmentManager, fragment: Fragment, saveFragment: SaveFragment?) :
			this(fragment.javaClass.name, fragment.arguments, if (saveFragment != null) {
