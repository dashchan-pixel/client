...
class GithubRepository(private val holder: HttpHolder, githubUri: Uri) {
	class Entry internal constructor(@JvmField val directory: Boolean,
	...
	fun listFiles(path: String): Map<String, Entry> {
		val uri = Uri.parse("https://api.github.com").buildUpon()
