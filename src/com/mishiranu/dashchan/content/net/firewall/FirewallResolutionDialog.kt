...
abstract class FirewallResolutionDialog<T> : WebViewDialog {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		val viewModel = ViewModelProvider(this).get(FirewallResolutionViewModel::class.java)
	...
	private fun checkFirewallResolutionFinished(url: String?, title: String?): Boolean {
