...
class AutohideStorage private constructor() : StorageManager.JsonOrgStorage<List<AutohideStorage.AutohideItem>>("autohide", 1000, 10000) {
    ...
    class AutohideItem : Parcelable {
        ...
        constructor(autohideItem: AutohideItem) : this(
            autohideItem.chanNames,
            autohideItem.boardName,
            autohideItem.threadNumber,
            autohideItem.optionOriginalPost,
            autohideItem.optionSage,
            autohideItem.optionSubject,
            autohideItem.optionComment,
            autohideItem.optionName,
            autohideItem.optionFileName,
            autohideItem.value,
        )

        constructor(
            chanNames: HashSet<String>?,
            boardName: String?,
            threadNumber: String?,
            optionOriginalPost: Boolean,
            optionSage: Boolean,
            optionSubject: Boolean,
            optionComment: Boolean,
            optionName: Boolean,
            optionFileName: Boolean,
            value: String?,
        ) {
            update(
                chanNames,
        ...
        companion object {
            @JvmStatic
            fun makePattern(value: String): Pattern = Pattern.compile(value, Pattern.CASE_INSENSITIVE or Pattern.DOTALL)

            @JvmField
            val CREATOR =
                object : Parcelable.Creator<AutohideItem> {
