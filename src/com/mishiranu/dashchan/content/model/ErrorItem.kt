...
class ErrorItem private constructor(
    @JvmField val type: Type?,
    @JvmField val specialType: Int,
    @JvmField val httpResponseCode: Int,
    @JvmField val message: String?,
    @JvmField val resId: Int,
) : Parcelable {
    enum class Type {
        UNKNOWN,
        API,
    ...
    companion object {
        @JvmField
        val CREATOR =
            object : Parcelable.Creator<ErrorItem> {
