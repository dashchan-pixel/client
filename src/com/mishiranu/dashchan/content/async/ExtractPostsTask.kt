...
class ExtractPostsTask(
    private val callback: Callback,
    private val cache: PagesDatabase.Cache?,
    private val chan: Chan,
    private val boardName: String?,
    private val threadNumber: String?,
    private val extractStateExtra: Boolean,
    private val cleanup: PagesDatabase.Cleanup,
) : ExecutorTask<Unit, ExtractPostsTask.Result?>() {
    interface Callback {
        fun onExtractPostsComplete(
            result: Result?,
            cancelled: Boolean,
        )
    }
    ...
    override fun run(): Result? {
        ...
        return Result(
            ...
            flags,
            stateExtra,
            meta?.archivedThreadUri,
            meta?.uniquePosters ?: 0,
        )
    }
