...
@Public
class HttpValidator(val entityTag: String?, val lastModified: String?) : Parcelable {
	...
	companion object {
		...
		@JvmField
		val CREATOR: Parcelable.Creator<HttpValidator> = object : Parcelable.Creator<HttpValidator> {
